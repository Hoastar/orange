...
// Information must be used to sign in: LoginM
type LoginM struct {
	UserName
	PassWord
}
...
type SysUserPage struct {
	...
	SysUserB
	LoginM
	DeptName string `gorm:"_" json:"deptName"`
}
...
// 重置密码
func (e *SysUser) SetPwd(pwd SysUserPwd) (Rseult bool, err error) {
